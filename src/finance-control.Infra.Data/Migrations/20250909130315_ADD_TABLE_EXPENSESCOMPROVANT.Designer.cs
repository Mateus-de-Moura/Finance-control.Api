...
namespace finance_control.Infra.Data.Migrations
{
    ...
    [Migration("20250909130315_ADD_TABLE_EXPENSESCOMPROVANT")]
    partial class ADD_TABLE_EXPENSESCOMPROVANT
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("finance_control.Domain.Entity.Expenses", b =>
                {
                    ...
                    b.HasIndex("ExpensesComprovantId")
                        .IsUnique()
                        .HasFilter("[ExpensesComprovantId] IS NOT NULL");
            ...
            modelBuilder.Entity("finance_control.Domain.Entity.ExpensesComprovant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExpensesComprovant", (string)null);
                });
            ...
            modelBuilder.Entity("finance_control.Domain.Entity.Expenses", b =>
                {
                    ...
                    b.HasOne("finance_control.Domain.Entity.ExpensesComprovant", "ExpensesComprovant")
                        .WithOne()
                        .HasForeignKey("finance_control.Domain.Entity.Expenses", "ExpensesComprovantId")
